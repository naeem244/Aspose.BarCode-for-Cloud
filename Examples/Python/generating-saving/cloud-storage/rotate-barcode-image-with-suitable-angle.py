...
try:
    ...
    response = barcodeApi.PutBarcodeGenerateFile(name, file= None, text=text, type=type, format=format, rotAngle=rotAngle, enableChecksum=enableChecksum, codeLocation=codeLocation)
